        ...
        />
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              name="email"
              label="Email"
              placeholder="IfraAnjum@.developer"
         ...
         {/* Address & Occupation */}
          ...
          <CustomFormField
              ...
              name="address"
              label="Address"
              placeholder="14 street, Faislabad"
            />
          ...
          <CustomFormField
           ...
           <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              placeholder="Mother had bloodPressure Problem, Father has hypertension"
            />
